...
class Item {
    ...
    function addItem() {
        ...
        " . $this->table_name . "
        SET
        item_name=:item_name, size=:size, quantity=:quantity, unit=:unit, timestamp=:timestamp,
        invoice_number=:invoice_number, vendor=:vendor, grade=:grade, rate=:rate, amount=:amount";
